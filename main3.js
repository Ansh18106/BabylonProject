...
const createScene = () => {
  ...
  canvas.addEventListener("pointerdown", function (event) {
    ...
    if (pickResult.hit && pickResult.pickedMesh === cube) {
      ...
      console.log(
        pickResult.pickedMesh.getVerticesData(BABYLON.VertexBuffer.PositionKind)
      );
